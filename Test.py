...
"""
print(P.getAdjacentTilesFromVertice((-2,-2)))
print(P.getAdjacentTilesFromVertice((-2,-1)))
print(P.getAdjacentTilesFromVertice((-2,0)))
print(P.getAdjacentTilesFromVertice((-2,1)))
print(P.getAdjacentTilesFromVertice((-2,2)))
print(P.getAdjacentTilesFromVertice((-2,3)))
print(P.getAdjacentTilesFromVertice((-2,4)))
print("Nouvelle Ligne")
print(P.getAdjacentTilesFromVertice((-1,-3)))
print(P.getAdjacentTilesFromVertice((-1,-2)))
print(P.getAdjacentTilesFromVertice((-1,-1)))
print(P.getAdjacentTilesFromVertice((-1,0)))
print(P.getAdjacentTilesFromVertice((-1,1)))
print(P.getAdjacentTilesFromVertice((-1,2)))
print(P.getAdjacentTilesFromVertice((-1,3)))
print(P.getAdjacentTilesFromVertice((-1,4)))
print(P.getAdjacentTilesFromVertice((-1,5)))
print("Nouvelle Ligne")
print(P.getAdjacentTilesFromVertice((0,-4)))
print(P.getAdjacentTilesFromVertice((0,-3)))
print(P.getAdjacentTilesFromVertice((0,-2)))
print(P.getAdjacentTilesFromVertice((0,-1)))
print(P.getAdjacentTilesFromVertice((0,0)))
print(P.getAdjacentTilesFromVertice((0,1)))
print(P.getAdjacentTilesFromVertice((0,2)))
print(P.getAdjacentTilesFromVertice((0,3)))
print(P.getAdjacentTilesFromVertice((0,4)))
print(P.getAdjacentTilesFromVertice((0,5)))
print(P.getAdjacentTilesFromVertice((0,6)))
print("Nouvelle Ligne")
print(P.getAdjacentTilesFromVertice((1,-4)))
print(P.getAdjacentTilesFromVertice((1,-3)))
print(P.getAdjacentTilesFromVertice((1,-2)))
...
print(P.getAdjacentTilesFromVertice((1,3)))
print(P.getAdjacentTilesFromVertice((1,4)))
print(P.getAdjacentVerticeFromVertice((1,5)))
print(P.getAdjacentTilesFromVertice((1,6)))
print("Nouvelle Ligne")
print(P.getAdjacentTilesFromVertice((2,-3)))
print(P.getAdjacentTilesFromVertice((2,-2)))
print(P.getAdjacentTilesFromVertice((2,-1)))
...
print(P.getAdjacentTilesFromVertice((2,3)))
print(P.getAdjacentTilesFromVertice((2,4)))
print(P.getAdjacentTilesFromVertice((2,5)))
print("Nouvelle Ligne")
print(P.getAdjacentTilesFromVertice((3,-2)))
print(P.getAdjacentTilesFromVertice((3,-1)))
print(P.getAdjacentTilesFromVertice((3,0)))
print(P.getAdjacentTilesFromVertice((3,1)))
print(P.getAdjacentTilesFromVertice((3,2)))
